  ...
  <div class="wrapper">
    ...
    <div class="main banner">
      <div class="banner-content">
        <h1>Jill Augustus</h1>
        <h2 class="sub-title">Front-end Developer & Designer</h2>
      ...
      <?php include("resume-nav.php"); ?>
    </div>

    <!--About Me-->

    <div class="inspiration" id="about">
    ...
    <!--Timeline -->
    <section class="container-background" id="experience">
    ...
    <div class="skills banner" id="hobbies">
      <div class="skill-box">
        <h1>Skills</h1>
    ...
    <div class="work col-12" id="projects">
      ...
      <div class="thumbnails grid">
        <div class="thumbnail">
            <picture>
                <source srcset="CSS/images/bentonitebeauty.jpeg"
                        media="(min-width: 600px)">
                <img class="thumbnail-img" src="CSS/images/bentonite-small.png"/>
            </picture>
                <div class="overlay">
            <div class="dropdown-text">
              <p>This is a website I did for my friend on Squarespace</p>
              <p>Skills used: Design, custom CSS</p>
            </div>
          </div></a>
        </div>
        <div class="thumbnail">
            <picture>
                <source srcset="CSS/images/eventure.jpeg"
                        media="(min-width: 600px)">
                <img class="thumbnail-img" src="CSS/images/eventure-small.png"/>
            </picture>
              <a href="https://github.com/CodemasterInstitute/Eventure/commits/Jill">
                <div class="overlay">
          <div class="dropdown-text">
            <p>This is a group project I contributed to during my course at Codemaster Institute</p>
            <p>Skills used: HTML, CSS, bootstrap, PHP, jQuery, Github featured work flow</p>
          </div>
          </div></a>
        </div>
      </div>
      <div class="thumbnails grid">
        <div class="thumbnail">
            <picture>
                <source srcset="CSS/images/ecosystem.jpg"
                        media="(min-width: 600px)">
                <img class="thumbnail-img" src="CSS/images/ecosystem-small.png"/>
            </picture>
          <!-- <img class="thumbnail-img" src="CSS/images/ecosystem.jpg"> -->
          <a href="https://github.com/Jma529/Object-constructors-Ecosystems">
            <div class="overlay">
          <div class="dropdown-text">
            <p>This is a project I worked on with a classmate at Codemaster Institute</p>
            <p>Skills used: JavaScript-object constructors, CSS animations, HTML5 audio tag, Github featured work flow</p>
          </div>
          </div></a>
        </div>
        <div class="thumbnail">
            <picture>
                <source srcset="CSS/images/wishuponalash.jpeg"
                        media="(min-width: 600px)">
                <img class="thumbnail-img" src="CSS/images/lashes-small.png"/>
            </picture>
          <a href="https://wishuponalash.com/">
            <div class="overlay">
          <div class="dropdown-text">
            <p>This is a website I assisted a friend with on Shopify</p>
            <p>Skills used: custom CSS, shopify plugins</p>
          </div>
          </div></a>
        </div>
      </div>
      <div class="in-progress">
        ...
        <div class="thumbnails grid">
            <div class="thumbnail">
                <img class="thumbnail-img" src="CSS/images/pizzaca.jpg" alt="thumbnail image of Pizzaca website">
                <a href="http://testsite.jilliemac.com">
                <div class="overlay">
                <div class="dropdown-text">
                  <p>This is website I am designing for an italian restaurant on WordPress</p>
                  <p>Skills used: Wireframes on Sketch, server hosting, php, CSS, WordPress CMS</p>
                </div>
                </div></a>
              </div>
              <div class="thumbnail">
                <img class="thumbnail-img" src="CSS/images/margoCoufosArt.jpg" alt="thumbnail image of Margo Coufos website">
                <a href="http://staging.jilliemac.com">
                <div class="overlay">
                <div class="dropdown-text">
                  <p>This is a website I am designing for an artist on WordPress</p>
                  <p>Skills used: Wireframes on Sketch, server hosting, php, CSS, WordPress CMS</p>
                </div>
                </div></a>
            </div>
    ...
    <div class="contact grid banner" id="contactme">
      ...
      <div class="get-in-touch">
        ...
        <span>Download pdf resume <a href="JillResumeOct2019.pdf">here</a></span>
