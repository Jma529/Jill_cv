...
<body>
  <div class="wrapper">
    ...
    <div class="inspiration">
      <div class="container-inspo">
        <div class="my-story col-6">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ad vero minima labore alias distinctio
            aspernatur, magni at dolores natus.</p>
        </div>
    ...
    <section class="timeline">
      ...
      <!-- <div class="timeline-item boulder">

        <div class="timeline-img"></div>

        <div class="timeline-content timeline-card js--fadeInRight">
          <div class="timeline-img-header boulder">
            <h2>Move to Boulder, CO</h2>
          </div>
